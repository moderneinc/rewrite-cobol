...
public class JCLLexer extends Lexer {
	...
	public static final int
		...
		UNKNOWN_TEXT=262;
	public static final int
		INSIDE_JCL=1, INSIDE_JCL_NAME=2, CM_IF_CONDITION=3, IF_CONDITION=4, INSIDE_STREAM=5,
		INSIDE_JES2=6, INSIDE_JES3=7, INSIDE_CM=8, INSIDE_TRAILING_COMMENT=9,
		INSIDE_COMMENT=10, INSIDE_UNKNOWN=11;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "INSIDE_JCL", "INSIDE_JCL_NAME", "CM_IF_CONDITION", "IF_CONDITION",
		"INSIDE_STREAM", "INSIDE_JES2", "INSIDE_JES3", "INSIDE_CM", "INSIDE_TRAILING_COMMENT",
		"INSIDE_COMMENT", "INSIDE_UNKNOWN"
	};
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TEXT", "LF", "CR", "FORM_FEED", "JCL_WS", "JCL_EOL", "JCL_IF", "JCL_STEP_START",
			"JCL_TC_START", "JCL_CA_START", "JCL_CNTL", "JCL_DATASET", "JCL_DD",
			...
			"JCL_STRINGLITERAL", "JCL_NAME_FIELD", "JCL_NAME_CHAR", "JCL_STEP_END",
			"JCL_STEP_NAME", "CM_IF_CONDITION_WS", "CM_IF_EOL", "CM_IF_CONDITION_CA_START",
			"CM_IF_CONDITION_STRINGLITERAL", "CM_IF_CONDITION_TEXT", "IF_CONDITION_WS",
			"IF_CONDITION_THEN", "IF_CONDITION_CA_START", "IF_CONDITION_STRINGLITERAL",
			"IF_CONDITION_TEXT", "STREAM_WS", "STREAM_EOL", "STREAM_CA_START", "STREAM_STRINGLITERAL",
			"STREAM_TEXT", "JES2_WS", "JES2_EOL", "JES2_CA_START", "JES2_STRINGLITERAL",
			"JES2_TEXT", "JES3_WS", "JES3_EOL", "JES3_CA_START", "JES3_STRINGLITERAL",
			"JES3_TEXT", "CM_WS", "CM_EOL", "CM_CA_START", "CM_IF", "CM_ELSE", "CM_ENDIF",
			"CM_STRINGLITERAL", "CM_TEXT", "TRAILING_COMMENT_WS", "TRAILING_COMMENT_EOL",
			"TRAILING_COMMENT_STOP", "TRAILING_COMMENT_STRINGLITERAL", "TRAILING_COMMENT_TEXT",
			"COMMENT_WS", "COMMENT_EOL", "COMMENT_CA_START", "COMMENT_STRINGLITERAL",
			"COMMENT_TEXT", "UNKNOWN_WS", "UNKNOWN_EOL", "UNKNOWN_CA_START", "UNKNOWN_STRINGLITERAL",
			"UNKNOWN_TEXT"
		};
	}
	...
	private static final String _serializedATNSegment0 =
		...
		"Z#\\$^%`&b\'d(f)h*j+l,n-p.r/t0v1x2z3|4~5\u00806\u00827\u00848\u00869\u0088"+
		":\u008a;\u008c<\u008e=\u0090>\u0092?\u0094@\u0096A\u0098B\u009aC\u009c"+
		"D\u009eE\u00a0F\u00a2G\u00a4H\u00a6I\u00a8J\u00aaK\u00acL\u00aeM\u00b0"+
		"N\u00b2O\u00b4P\u00b6Q\u00b8R\u00baS\u00bcT\u00beU\u00c0V\u00c2W\u00c4"+
		"X\u00c6Y\u00c8Z\u00ca[\u00cc\\\u00ce]\u00d0^\u00d2_\u00d4`\u00d6a\u00d8"+
		"b\u00dac\u00dcd\u00dee\u00e0f\u00e2g\u00e4h\u00e6i\u00e8j\u00eak\u00ec"+
		"l\u00eem\u00f0n\u00f2o\u00f4p\u00f6q\u00f8r\u00fas\u00fct\u00feu\u0100"+
		"v\u0102w\u0104x\u0106y\u0108z\u010a{\u010c|\u010e}\u0110~\u0112\u007f"+
		"\u0114\u0080\u0116\u0081\u0118\u0082\u011a\u0083\u011c\u0084\u011e\u0085"+
		"\u0120\u0086\u0122\u0087\u0124\u0088\u0126\u0089\u0128\u008a\u012a\u008b"+
		"\u012c\u008c\u012e\u008d\u0130\u008e\u0132\u008f\u0134\u0090\u0136\u0091"+
