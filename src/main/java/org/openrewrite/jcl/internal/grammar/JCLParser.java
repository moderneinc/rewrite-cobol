...
public class JCLParser extends Parser {
	...
	public static final int
		UTF_8_BOM=1, WS=2, EOL=3, JCL_STATEMENT=4, JCL_CONTINUATION=5, JCL_STREAM=6, 
		JES2=7, JES3=8, CM=9, COMMENT=10, UNKNOWN=11, CA_START=12, STRINGLITERAL=13, 
		TEXT=14, JCL_TC_START=15, JCL_TC_STOP=16, JCL_STRINGLITERAL=17, JCL_TEXT=18, 
		STREAM_WS=19, STREAM_STRINGLITERAL=20, STREAM_TEXT=21, JES2_STRINGLITERAL=22, 
		JES2_TEXT=23, JES3_STRINGLITERAL=24, JES3_TEXT=25, CM_STRINGLITERAL=26, 
		CM_TEXT=27, COMMENT_WS=28, COMMENT_STRINGLITERAL=29, COMMENT_TEXT=30, 
		UNKNOWN_WS=31, UNKNOWN_STRINGLITERAL=32, UNKNOWN_TEXT=33;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'\\uFEFF'", null, null, null, null, "'^^STREAM^^'", null, null, 
			"'^^CM^^'", "'^^COMMENT^^'", "'^^UNKNOWN^^'", "'^^CA_START^^'", null, 
			null, "'^^TC_START^^'", "'^^TC_STOP^^'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"JCL_STREAM", "JES2", "JES3", "CM", "COMMENT", "UNKNOWN", "CA_START", 
			"STRINGLITERAL", "TEXT", "JCL_TC_START", "JCL_TC_STOP", "JCL_STRINGLITERAL", 
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 14763298816L) != 0)) {
				{
				{
				setState(48);
				statement();
