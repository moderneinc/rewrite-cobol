 ...
 */
package org.openrewrite.controlcard.sort.tree;
...
/**
 * What separates one word of a sort deck from the next: white space, and the comment cards written
 * between statements, which carry no meaning of their own but have to print back where they were.
 */
@EqualsAndHashCode
