...
public class ControlMLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ODAT", "STAT", "PREV", "PLUS_CHAR", "MINUS_CHAR", "INCR_DATE", "DECR_DATE",
			"ANY_DATE", "NAME", "LF", "CR", "FORM_FEED", "DEFINITION_END", "DEFINITION_DESC",
			...
			"INPUT_NAMES_IN", "INPUT_NAMES_LINE_START", "INPUT_NAMES_LINE_END", "INPUT_ODAT",
			"INPUT_STAT", "INPUT_PREV", "INPUT_PLUS_CHAR", "INPUT_MINUS_CHAR", "INPUT_INCR_DATE",
			"INPUT_DECR_DATE", "INPUT_ANY_DATE", "INPUT_NAMES_NAME", "OUTPUT_END",
			"OUTPUT_NAMES_START", "OUTPUT_WS", "OUTPUT_EOL", "OUTPUT_HEADER", "OUTPUT_LINE_START",
			"OUTPUT_LINE_END", "OUTPUT_NAME", "OUTPUT_NAMES_END", "OUTPUT_NAMES_WS",
			"OUTPUT_NAMES_EOL", "OUTPUT_NAMES_OUT", "OUTPUT_NAMES_LINE_START", "OUTPUT_NAMES_LINE_END",
			"OUTPUT_ODAT", "OUTPUT_STAT", "OUTPUT_PREV", "OUTPUT_PLUS_CHAR", "OUTPUT_MINUS_CHAR",
			"OUTPUT_INCR_DATE", "OUTPUT_DECR_DATE", "OUTPUT_ANY_DATE", "OUTPUT_NAMES_NAME",
			"APP_FORM_END", "APP_FORM_WS", "APP_FORM_EOL", "APP_FORM_SECTION_HEADER",
			"APP_FORM_LINE_START", "APP_FORM_LINE_END", "APP_FORM_NAME", "DESC_TEXT_END",
			"DESC_TEXT_WS", "DESC_TEXT_EOL", "DESC_TEXT_LINE_START", "DESC_TEXT_DESC",
			"DESC_TEXT_WORD"
		};
	}
	...
	public static final String _serializedATN =
		...
		"m\u0001m\u0001n\u0001n\u0001n\u0001n\u0001o\u0001o\u0001o\u0001o\u0001"+
		"o\u0001p\u0001p\u0001p\u0001p\u0001q\u0001q\u0001q\u0001q\u0001r\u0001"+
		"r\u0001r\u0001r\u0001s\u0001s\u0001s\u0001s\u0001t\u0004t\u0493\bt\u000b"+
		"t\ft\u0494\u0000\u0000u\t\u0001\u000b\u0002\r\u0003\u000f\u0004\u0011"+
		"\u0005\u0013\u0006\u0015\u0007\u0017\b\u0019\t\u001b\n\u001d\u000b\u001f"+
		"\f!\r#\u000e%\u000f\'\u0010)\u0011+\u0012-\u0013/\u00141\u00003\u0000"+
		"5\u00007\u00159\u0016;\u0017=\u0018?\u0019A\u001aC\u001bE\u001cG\u001d"+
		"I\u001eK\u001fM O!Q\"S#U$W%Y&[\'](_)a*c+e,g-i.k/m\u0000o0q1s2u3w4y5{\u0000"+
		"}6\u007f7\u00818\u00839\u0085:\u0087;\u0089<\u008b\u0000\u008d=\u008f"+
		">\u0091?\u0093@\u0095A\u0097B\u0099\u0000\u009b\u0000\u009d\u0000\u009f"+
		"\u0000\u00a1\u0000\u00a3\u0000\u00a5\u0000\u00a7\u0000\u00a9\u0000\u00ab"+
		"C\u00adD\u00afE\u00b1F\u00b3G\u00b5H\u00b7I\u00b9\u0000\u00bbJ\u00bdK"+
