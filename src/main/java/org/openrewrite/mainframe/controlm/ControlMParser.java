...
import org.openrewrite.mainframe.controlm.internal.ControlMParserVisitor;
import org.openrewrite.mainframe.controlm.internal.ExportReader;
import org.openrewrite.mainframe.controlm.internal.grammar.ControlMLexer;
                ...
                .map(sourceFile -> {
                    ...
                    try {
                        ...
                        if (ExportReader.isExport(sourceStr)) {
                            ...
                            org.openrewrite.mainframe.controlm.internal.grammar.ControlMParser parser = new org.openrewrite.mainframe.controlm.internal.grammar.ControlMParser(new CommonTokenStream(new ControlMLexer(
