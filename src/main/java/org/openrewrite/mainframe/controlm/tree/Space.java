 ...
 */
package org.openrewrite.mainframe.controlm.tree;
...
public class Space {
    ...
    public enum Location {
        ...
        APPLICATION_FORM_SECTION_PREFIX,
        ATTRIBUTE_PREFIX,
        ATTRIBUTE_BEFORE_EQUALS,
        COLUMN_START_PREFIX,
        COLUMN_END_PREFIX,
        DEFINITION_SECTION_PREFIX,
        DESCRIPTION_PREFIX,
        DIRECTIVE_PREFIX,
        ELEMENT_PREFIX,
        ELEMENT_BEFORE_TAG_END,
        ELEMENT_BEFORE_END_TAG,
        INPUT_PREFIX,
        INPUT_SECTION_PREFIX,
        LINE_PREFIX,
        OUTPUT_PREFIX,
        OUTPUT_SECTION_PREFIX,
        PARAMETER_PREFIX,
        SCHEDULE_SECTION_PREFIX,
        SET_VAR_PREFIX,
        SET_VAR_INITIALIZER,
        WORD_PREFIX,
    }
