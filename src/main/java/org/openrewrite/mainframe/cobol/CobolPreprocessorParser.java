...
import org.openrewrite.mainframe.cobol.internal.CobolPreprocessorParserVisitor;
import org.openrewrite.mainframe.cobol.internal.grammar.CobolPreprocessorLexer;
        ...
        return acceptedInputs(sourceFiles)
                .map(sourceFile -> {
                    ...
                    try {
                        ...
                        org.openrewrite.mainframe.cobol.internal.grammar.CobolPreprocessorParser parser =
                                new org.openrewrite.mainframe.cobol.internal.grammar.CobolPreprocessorParser(new CommonTokenStream(lexer));
