...
public class CobolLexer extends Lexer {
	...
	public static final int
		...
		INSPECT=254, INSTALLATION=255, INTEGER=256, INTERFACE=257, INTO=258, INTRINSIC=259, 
		INVALID=260, INVOKE=261, IS=262, JUST=263, JUSTIFIED=264, KANJI=265, KEPT=266, 
		KEY=267, KEYBOARD=268, LABEL=269, LANGUAGE=270, LAST=271, LB=272, LD=273, 
		LEADING=274, LEFT=275, LEFTLINE=276, LENGTH=277, LENGTH_CHECK=278, LESS=279, 
		LIBACCESS=280, LIBPARAMETER=281, LIBRARY=282, LIMIT=283, LIMITS=284, LINAGE=285, 
		LINAGE_COUNTER=286, LINE=287, LINES=288, LINE_COUNTER=289, LINKAGE=290, 
		LIST=291, LOCAL=292, LOCAL_STORAGE=293, LOCK=294, LONG_DATE=295, LONG_TIME=296, 
		LOWER=297, LOWLIGHT=298, LOW_VALUE=299, LOW_VALUES=300, MEMORY=301, MERGE=302, 
		MESSAGE=303, METHOD=304, MMDDYYYY=305, MODE=306, MODULES=307, MORE_LABELS=308, 
		MOVE=309, MULTIPLE=310, MULTIPLY=311, NAMED=312, NATIONAL=313, NATIONAL_EDITED=314, 
		NATIVE=315, NEGATIVE=316, NETWORK=317, NEXT=318, NO=319, NO_ECHO=320, 
		NOT=321, NULL=322, NULLS=323, NUMBER=324, NUMERIC=325, NUMERIC_DATE=326, 
		NUMERIC_EDITED=327, NUMERIC_TIME=328, OBJECT_COMPUTER=329, OCCURS=330, 
		ODT=331, OF=332, OFF=333, OMITTED=334, ON=335, OPEN=336, OPTIONAL=337, 
		OR=338, ORDER=339, ORDERLY=340, ORGANIZATION=341, OTHER=342, OUTPUT=343, 
		OVERFLOW=344, OVERLINE=345, OWN=346, PACKED_DECIMAL=347, PADDING=348, 
		PAGE=349, PAGE_COUNTER=350, PARAGRAPH=351, PASSWORD=352, PERFORM=353, 
		PF=354, PH=355, PIC=356, PICTURE=357, PLUS=358, POINTER=359, POSITION=360, 
		POSITIVE=361, PORT=362, PRINTER=363, PRINTING=364, PRIVATE=365, PROCEDURE=366, 
		PROCEDURE_POINTER=367, PROCEDURES=368, PROCEED=369, PROCESS=370, PROGRAM=371, 
		PROGRAM_ID=372, PROGRAM_LIBRARY=373, PROMPT=374, PURGE=375, QUEUE=376, 
		QUOTE=377, QUOTES=378, RANDOM=379, READER=380, REMOTE=381, RD=382, REAL=383, 
		READ=384, RECEIVE=385, RECEIVED=386, RECORD=387, RECORDING=388, RECORDS=389, 
		RECURSIVE=390, REDEFINES=391, REEL=392, REF=393, REFERENCE=394, REFERENCES=395, 
		RELATIVE=396, RELEASE=397, REMAINDER=398, REMARKS=399, REMOVAL=400, REMOVE=401, 
		RENAMES=402, REPLACE=403, REPLACING=404, REPORT=405, REPORTING=406, REPORTS=407, 
		REPOSITORY=408, REQUIRED=409, RERUN=410, RESERVE=411, REVERSE_VIDEO=412, 
		...
		SPACE=461, SPACES=462, SPECIAL_NAMES=463, SQL=464, STANDARD=465, STANDARD_1=466, 
		...
		TODAYS_NAME=503, TOP=504, TRAILING=505, TRUE=506, TRUNCATED=507, TYPE=508, 
		TYPEDEF=509, UNDERLINE=510, UNIT=511, UNSTRING=512, UNTIL=513, UP=514, 
		UPON=515, USAGE=516, USE=517, USING=518, VALUE=519, VALUES=520, VARYING=521, 
		VIRTUAL=522, WAIT=523, WHEN=524, WHEN_COMPILED=525, WITH=526, WORDS=527, 
		WORKING_STORAGE=528, WRITE=529, YEAR=530, YYYYMMDD=531, YYYYDDD=532, ZERO=533, 
		ZERO_FILL=534, ZEROS=535, ZEROES=536, AMPCHAR=537, ASTERISKCHAR=538, DOUBLEASTERISKCHAR=539, 
		COLONCHAR=540, COMMACHAR=541, COMMENTENTRYTAG=542, COMMENTTAG=543, DOLLARCHAR=544, 
		DOUBLEQUOTE=545, DOT_FS=546, EQUALCHAR=547, EXECCICSTAG=548, EXECDLITAG=549, 
		EXECSQLTAG=550, EXECSQLIMSTAG=551, LESSTHANCHAR=552, LESSTHANOREQUAL=553, 
		LPARENCHAR=554, MINUSCHAR=555, MORETHANCHAR=556, MORETHANOREQUAL=557, 
		NOTEQUALCHAR=558, PLUSCHAR=559, SINGLEQUOTE=560, RPARENCHAR=561, SLASHCHAR=562, 
		NONNUMERICLITERAL=563, LEVEL_NUMBER_66=564, LEVEL_NUMBER_77=565, LEVEL_NUMBER_88=566, 
		INTEGERLITERAL=567, NUMERICLITERAL=568, IDENTIFIER=569, SEPARATOR=570, 
		NEWLINE=571, EXECCICSLINE=572, EXECDLILINE=573, EXECSQLIMSLINE=574, EXECSQLLINE=575, 
		COMMENTENTRYLINE=576, COMMENTLINE=577, WS=578;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"INTERFACE", "INTO", "INTRINSIC", "INVALID", "INVOKE", "IS", "JUST", 
			...
			"NETWORK", "NEXT", "NO", "NO_ECHO", "NOT", "NULL", "NULLS", "NUMBER", 
			...
			"DOT_FS", "EQUALCHAR", "EXECCICSTAG", "EXECDLITAG", "EXECSQLTAG", "EXECSQLIMSTAG", 
			...
			"INTEGERLITERAL", "NUMERICLITERAL", "IDENTIFIER", "SEPARATOR", "NEWLINE", 
			"EXECCICSLINE", "EXECDLILINE", "EXECSQLIMSLINE", "EXECSQLLINE", "COMMENTENTRYLINE", 
			"COMMENTLINE", "WS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'INTEGER'", "'INTERFACE'", "'INTO'", "'INTRINSIC'", "'INVALID'", "'INVOKE'", 
			"'IS'", "'JUST'", "'JUSTIFIED'", "'KANJI'", "'KEPT'", "'KEY'", "'KEYBOARD'", 
			"'LABEL'", "'LANGUAGE'", "'LAST'", "'LB'", "'LD'", "'LEADING'", "'LEFT'", 
			"'LEFTLINE'", "'LENGTH'", "'LENGTH-CHECK'", "'LESS'", "'LIBACCESS'", 
			"'LIBPARAMETER'", "'LIBRARY'", "'LIMIT'", "'LIMITS'", "'LINAGE'", "'LINAGE-COUNTER'", 
			"'LINE'", "'LINES'", "'LINE-COUNTER'", "'LINKAGE'", "'LIST'", "'LOCAL'", 
			"'LOCAL-STORAGE'", "'LOCK'", "'LONG-DATE'", "'LONG-TIME'", "'LOWER'", 
			"'LOWLIGHT'", "'LOW-VALUE'", "'LOW-VALUES'", "'MEMORY'", "'MERGE'", "'MESSAGE'", 
			"'METHOD'", "'MMDDYYYY'", "'MODE'", "'MODULES'", "'MORE-LABELS'", "'MOVE'", 
			"'MULTIPLE'", "'MULTIPLY'", "'NAMED'", "'NATIONAL'", "'NATIONAL-EDITED'", 
			"'NATIVE'", "'NEGATIVE'", "'NETWORK'", "'NEXT'", "'NO'", "'NO-ECHO'", 
			"'NOT'", "'NULL'", "'NULLS'", "'NUMBER'", "'NUMERIC'", "'NUMERIC-DATE'", 
			"'NUMERIC-EDITED'", "'NUMERIC-TIME'", "'OBJECT-COMPUTER'", "'OCCURS'", 
			"'ODT'", "'OF'", "'OFF'", "'OMITTED'", "'ON'", "'OPEN'", "'OPTIONAL'", 
			"'OR'", "'ORDER'", "'ORDERLY'", "'ORGANIZATION'", "'OTHER'", "'OUTPUT'", 
			"'OVERFLOW'", "'OVERLINE'", "'OWN'", "'PACKED-DECIMAL'", "'PADDING'", 
			"'PAGE'", "'PAGE-COUNTER'", "'PARAGRAPH'", "'PASSWORD'", "'PERFORM'", 
			"'PF'", "'PH'", "'PIC'", "'PICTURE'", "'PLUS'", "'POINTER'", "'POSITION'", 
			"'POSITIVE'", "'PORT'", "'PRINTER'", "'PRINTING'", "'PRIVATE'", "'PROCEDURE'", 
			"'PROCEDURE-POINTER'", "'PROCEDURES'", "'PROCEED'", "'PROCESS'", "'PROGRAM'", 
			"'PROGRAM-ID'", "'PROGRAM-LIBRARY'", "'PROMPT'", "'PURGE'", "'QUEUE'", 
			"'QUOTE'", "'QUOTES'", "'RANDOM'", "'READER'", "'REMOTE'", "'RD'", "'REAL'", 
			"'READ'", "'RECEIVE'", "'RECEIVED'", "'RECORD'", "'RECORDING'", "'RECORDS'", 
			"'RECURSIVE'", "'REDEFINES'", "'REEL'", "'REF'", "'REFERENCE'", "'REFERENCES'", 
			"'RELATIVE'", "'RELEASE'", "'REMAINDER'", "'REMARKS'", "'REMOVAL'", "'REMOVE'", 
			"'RENAMES'", "'REPLACE'", "'REPLACING'", "'REPORT'", "'REPORTING'", "'REPORTS'", 
			"'REPOSITORY'", "'REQUIRED'", "'RERUN'", "'RESERVE'", "'RESERVE-VIDEO'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SEPARATOR", "NEWLINE", "EXECCICSLINE", "EXECDLILINE", "EXECSQLIMSLINE", 
	...
	private static final String _serializedATNSegment0 =
		...
		"\u023a\u047d\u023b\u047f\u023c\u0481\u023d\u0483\u023e\u0485\u023f\u0487"+
		"\u0240\u0489\u0241\u048b\u0242\u0001\u0000$\u0002\u0000AAaa\u0002\u0000"+
		"BBbb\u0002\u0000OOoo\u0002\u0000RRrr\u0002\u0000TTtt\u0002\u0000CCcc\u0002"+
		"\u0000EEee\u0002\u0000PPpp\u0002\u0000SSss\u0002\u0000DDdd\u0002\u0000"+
		"VVvv\u0002\u0000NNnn\u0002\u0000IIii\u0002\u0000GGgg\u0002\u0000FFff\u0002"+
		"\u0000LLll\u0002\u0000HHhh\u0002\u0000WWww\u0002\u0000UUuu\u0002\u0000"+
		"MMmm\u0002\u0000YYyy\u0002\u0000KKkk\u0002\u0000QQqq\u0002\u0000XXxx\u0002"+
		"\u0000ZZzz\u0002\u0000JJjj\u0003\u000009AFaf\u0003\u0000\n\n\r\r\"\"\u0003"+
		"\u0000\n\n\r\r\'\'\u0004\u0000GGNNggnn\u0001\u000009\u0003\u000009AZa"+
		"z\u0002\u0000--__\u0003\u0000\n\n\r\r}}\u0002\u0000\n\n\r\r\u0004\u0000"+
		"\t\t\f\f  ;;\u177c\u0000\u0001\u0001\u0000\u0000\u0000\u0000\u0003\u0001"+
		"\u0000\u0000\u0000\u0000\u0005\u0001\u0000\u0000\u0000\u0000\u0007\u0001"+
		"\u0000\u0000\u0000\u0000\t\u0001\u0000\u0000\u0000\u0000\u000b\u0001\u0000"+
