...
public class CobolLexer extends Lexer {
	...
	public static final int
		...
		NUMERICLITERAL=561, IDENTIFIER=562, SEPARATOR=563, NEWLINE=564, EXECCICSLINE=565,
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'CURSOR'", "'DATA'", "'DATA-BASE'", "'DATE'", "'DATE-COMPILED'", "'DATE-WRITTEN'",
			"'DAY'", "'DAY-OF-WEEK'", "'DBCS'", "'DBCLOB'", "'DE'", "'DEBUG-CONTENTS'",
			...
			"'LOW-VALUES'", "'MEMORY'", "'MERGE'", "'MESSAGE'", "'MMDDYYYY'", "'MODE'",
			"'MODULES'", "'MORE-LABELS'", "'MOVE'", "'MULTIPLE'", "'MULTIPLY'", "'NAMED'",
			"'NATIONAL'", "'NATIONAL-EDITED'", "'NATIVE'", "'NEGATIVE'", "'NETWORK'",
			"'NEXT'", "'NO'", "'NO-ECHO'", "'NOT'", "'NULL'", "'NULLS'", "'NUMBER'",
			"'NUMERIC'", "'NUMERIC-DATE'", "'NUMERIC-EDITED'", "'NUMERIC-TIME'",
			...
			"'PORT'", "'PRINTER'", "'PRINTING'", "'PRIVATE'", "'PROCEDURE'", "'PROCEDURE-POINTER'",
			"'PROCEDURES'", "'PROCEED'", "'PROCESS'", "'PROGRAM'", "'PROGRAM-ID'",
			"'PROGRAM-LIBRARY'", "'PROMPT'", "'PURGE'", "'QUEUE'", "'QUOTE'", "'QUOTES'",
			"'RANDOM'", "'READER'", "'REMOTE'", "'RD'", "'REAL'", "'READ'", "'RECEIVE'",
			"'RECEIVED'", "'RECORD'", "'RECORDING'", "'RECORDS'", "'RECURSIVE'",
			"'REDEFINES'", "'REEL'", "'REF'", "'REFERENCE'", "'REFERENCES'", "'RELATIVE'",
			"'RELEASE'", "'REMAINDER'", "'REMARKS'", "'REMOVAL'", "'REMOVE'", "'RENAMES'",
			"'REPLACE'", "'REPLACING'", "'REPORT'", "'REPORTING'", "'REPORTS'", "'REQUIRED'",
			"'RERUN'", "'RESERVE'", "'RESERVE-VIDEO'", "'RESET'", "'RETURN'", "'RETURN-CODE'",
			"'RETURNING'", "'REVERSED'", "'REWIND'", "'REWRITE'", "'RF'", "'RH'",
			"'RIGHT'", "'ROUNDED'", "'RUN'", "'SAME'", "'SAVE'", "'SCREEN'", "'SD'",
			"'SEARCH'", "'SECTION'", "'SECURE'", "'SECURITY'", "'SEGMENT'", "'SEGMENT-LIMIT'",
			"'SELECT'", "'SEND'", "'SENTENCE'", "'SEPARATE'", "'SEQUENCE'", "'SEQUENTIAL'",
			"'SET'", "'SHARED'", "'SHAREDBYALL'", "'SHAREDBYRUNUNIT'", "'SHARING'",
			"'SHIFT-IN'", "'SHIFT-OUT'", "'SHORT-DATE'", "'SIGN'", "'SIZE'", "'SORT'",
			...
			"'TEXT'", "'THAN'", "'THEN'", "'THREAD'", "'THREAD-LOCAL'", "'THROUGH'",
			"'THRU'", "'TIME'", "'TIMER'", "'TIMES'", "'TITLE'", "'TO'", "'TODAYS-DATE'",
			"'TODAYS-NAME'", "'TOP'", "'TRAILING'", "'TRUE'", "'TRUNCATED'", "'TYPE'",
			"'TYPEDEF'", "'UNDERLINE'", "'UNIT'", "'UNSTRING'", "'UNTIL'", "'UP'",
			"'UPON'", "'USAGE'", "'USE'", "'USING'", "'VALUE'", "'VALUES'", "'VARYING'",
			"'VIRTUAL'", "'WAIT'", "'WHEN'", "'WHEN-COMPILED'", "'WITH'", "'WORDS'",
			"'WORKING-STORAGE'", "'WRITE'", "'YEAR'", "'YYYYMMDD'", "'YYYYDDD'",
	...
	private static final String _serializedATNSegment0 =
		...
		"\u046f\u0234\u0471\u0235\u0473\u0236\u0475\u0237\u0477\u0238\u0479\u0239"+
		"\u047b\u023a\u0001\u0000$\u0002\u0000AAaa\u0002\u0000BBbb\u0002\u0000"+
		"OOoo\u0002\u0000RRrr\u0002\u0000TTtt\u0002\u0000CCcc\u0002\u0000EEee\u0002"+
		"\u0000PPpp\u0002\u0000SSss\u0002\u0000DDdd\u0002\u0000VVvv\u0002\u0000"+
		"NNnn\u0002\u0000IIii\u0002\u0000GGgg\u0002\u0000FFff\u0002\u0000LLll\u0002"+
		"\u0000HHhh\u0002\u0000WWww\u0002\u0000UUuu\u0002\u0000MMmm\u0002\u0000"+
		"YYyy\u0002\u0000KKkk\u0002\u0000QQqq\u0002\u0000XXxx\u0002\u0000ZZzz\u0002"+
		"\u0000JJjj\u0003\u000009AFaf\u0003\u0000\n\n\r\r\"\"\u0003\u0000\n\n\r"+
		"\r\'\'\u0004\u0000GGNNggnn\u0001\u000009\u0003\u000009AZaz\u0002\u0000"+
		"--__\u0003\u0000\n\n\r\r}}\u0002\u0000\n\n\r\r\u0004\u0000\t\t\f\f  ;"+
		";\u1716\u0000\u0001\u0001\u0000\u0000\u0000\u0000\u0003\u0001\u0000\u0000"+
		"\u0000\u0000\u0005\u0001\u0000\u0000\u0000\u0000\u0007\u0001\u0000\u0000"+
		"\u0000\u0000\t\u0001\u0000\u0000\u0000\u0000\u000b\u0001\u0000\u0000\u0000"+
