...
DEF_REGEX_NAME : REGEX_NAME -> type(REGEX_NAME);
...
INPUT_REGEX_NAME : REGEX_NAME -> type(REGEX_NAME);
...
OUTPUT_REGEX_NAME : REGEX_NAME -> type(REGEX_NAME);
...
APP_FORM_REGEX_NAME : REGEX_NAME -> type(REGEX_NAME);
APP_FORM_TEXT : ~[\r\n|]+;
