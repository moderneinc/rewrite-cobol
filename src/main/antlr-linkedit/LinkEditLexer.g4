...
// Hidden rather than skipped: a card continues the statement above it only because column 72 of that
// card held something, and only the line reader has looked there. Skipping these would throw away
// the one thing needed to group words back into statements.
