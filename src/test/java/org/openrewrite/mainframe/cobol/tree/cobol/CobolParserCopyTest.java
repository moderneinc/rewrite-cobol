...
import static org.openrewrite.mainframe.cobol.Assertions.cobolPostProcess;
...
class CobolParserCopyTest extends CobolTest {
    ...
    void sm101A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM101A.CBL"), sm101A)
        );
    }
    ...
    void sm103A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM103A.CBL"), sm103A)
        );
    }
    ...
    void sm105A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM105A.CBL"), sm105A)
        );
    }
    ...
    void sm106A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM106A.CBL"), sm106A)
        );
    }
    ...
    void sm107A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM107A.CBL"), sm107A)
        );
    }
    ...
    void sm207A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM207A.CBL"), sm207A)
        );
    }
    ...
    void sm301M() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM301M.CBL"), sm301M)
        );
    }
    ...
    void sm401M() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM401M.CBL"), sm401M)
        );
    }
