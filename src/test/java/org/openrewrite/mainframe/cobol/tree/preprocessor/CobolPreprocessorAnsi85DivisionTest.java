            ...
            000000* The continuation tests assert a literal was not split into      000000000
                  * multiple tokens.                                                000000000
                   ...
                   PROGRAM-ID.                                                      000000000
                       CM101M.                                                      000000000
                   DATA DIVISION.                                                   000000000
                   WORKING-STORAGE SECTION.                                         000000000
                   01  LOG-HDR-4.                                                   000000000
                           02  FILLER PIC X VALUE                                   000000000
                  -        'this is a variant of the continuation of a literal      000000000
                  -        'and will print without issues if detected correctly'.   000000000
                       02  FILLER PIC X(11) VALUE ALL "-".                          000000000
                       02  FILLER PIC X VALUE SPACES.                               000000000
            """
          )
        );
    }
          ...
          preprocessor(
            ...
            000000* The continuation tests assert a literal was not split into      000000000
                  * multiple tokens.                                                000000000
                   ...
                   WORKING-STORAGE SECTION.                                         000000000
                   01  LOG-HDR-4.                                                   000000000
                           02  FILLER PIC X VALUE                           "this is000000000
                  -        "another variant of a continuation".                     000000000
                       02  FILLER PIC X(11) VALUE ALL "-".                          000000000
                       02  FILLER PIC X VALUE SPACES.                               000000000
            """
          )
          ...
          preprocessor(
            ...
            000000* The continuation tests assert a literal was not split into      000000000
                  * multiple tokens.                                                000000000
                   ...
                   WORKING-STORAGE SECTION.                                         000000000
                   01  LOG-HDR-4.                                                   000000000
                           02  FILLER PIC X VALUE                          "this is"000000000
                  -        ""another variant of a continuation".                    000000000
                       02  FILLER PIC X(11) VALUE ALL "-".                          000000000
                       02  FILLER PIC X VALUE SPACES.                               000000000
            """
        ...
        rewriteRun(
          preprocessor(
            ...
            000100 IDENTIFICATION DIVISION.                                         000000000
                   ...
                   01  LOG-HDR-4.                                                   000000000
                           02  FILLER PIC X VALUE                                   000000000
                  -        'line 1                                            today'000000000
                  -        ''s date                                          line 2 000000000
                  -        'line 3'.                                                000000000
                       02  FILLER PIC X(11) VALUE ALL "-".                          000000000
                       02  FILLER PIC X VALUE SPACES.                               000000000
            """
