...
class CobolParserReplaceTest extends CobolTest {
    ...
    void sm201A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM201A.CBL"), sm201A)
        );
    }
    ...
    void sm202A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM202A.CBL"), sm202A)
        );
    }
    ...
    void sm203A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM203A.CBL"), sm203A)
        );
    }
    ...
    void sm205A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM205A.CBL"), sm205A)
        );
    }
    ...
    void sm206A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM206A.CBL"), sm206A)
        );
    }
    ...
    void sm208A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM208A.CBL"), sm208A)
        );
    }
    ...
    void sm201ATrailingSub() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM201A_TRAILING_SUB.CBL"), sm201A)
        );
    }
